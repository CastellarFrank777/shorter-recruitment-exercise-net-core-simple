...
- Complete the logic for the User.ExpiredSubscriptions property following the directions given.
	...
	- Implement the ExpiredSubscriptions property in User class. An user has a list of subscriptions, which some of those scriptions may be expired. This property must return the number of expired subscriptions that the user has. Be aware that you can do any coding you need in both the Subscription and the User classes to solve the exercise, after you implement this property correctly the first three tests should pass.
